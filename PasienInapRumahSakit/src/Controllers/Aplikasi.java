...
public class Aplikasi {
    ...
    public void simpanDokter(ArrayList<Dokter> daftarDokter) {
        try (FileOutputStream fosd = new FileOutputStream("DokterTubes.txt");
    ...
    public void simpanPasien(ArrayList<Pasien> daftarPasien) {
        try (FileOutputStream fosp = new FileOutputStream("PasienTubes.txt");
    ...
    public void simpanRuangan(ArrayList<Ruangan> daftarRuangan) {
        try (FileOutputStream fosr = new FileOutputStream("RuanganTubes.txt");
    ...
    public ArrayList<Dokter> bacaDokter() {
        ...
        //InputStream input= new FileInputStream("DokterTubes.dat");
        File f = new File("DokterTubes.txt");
        if (f.exists()) {
        try (
    ...
    public ArrayList<Pasien> bacaPasien() {
        ...
        File f = new File("PasienTubes.txt");
        if (f.exists()) {
    ...
    public ArrayList<Ruangan> bacaRuangan() {
        ...
        File f = new File("RuanganTubes.txt");
        if (f.exists()) {
